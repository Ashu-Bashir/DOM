...
div3.style.color = 'aqua'
const k = getComputedStyle(div3)
console.log(k.backgroundColor)      // rgba(255, 0, 0, 0)
console.log(k.color)                // rgb(0, 0, 255)


// getComputedStyle() is a method in JavaScript that returns the computed styles of an element, such as the values of CSS properties like font-size, color, margin, padding, etc.